...
public class HbaseStart
{
	...
	public static void createTable() throws IOException
	{
		...
		try {
			// HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("SensorTagTablekumar1"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",Humidity="";
		  ...
		  HTable table = new HTable(config, "SensorTagTablekumar1");
 		...
 		try {
 			...
 			while ((sCurrentLine = br.readLine()) != null) {
 				...
 				// p.add(Bytes.toBytes("longitude"), Bytes.toBytes("col"+(count+1)),Bytes.toBytes(longitude));
 				 ...
 				 p.add(Bytes.toBytes("Accelerometer"), Bytes.toBytes("col"+(count+4)),Bytes.toBytes(x+","+y+","+z));
 				 

 				 p.add(Bytes.toBytes("Humidity"), Bytes.toBytes("col"+(count+3)),Bytes.toBytes(Humidity));
	...
	public static void retrieveTable() throws IOException{
		...
		config.clear();
         ...
         config.set("hbase.master", "134.193.136.127:60010");
		  ...
		  HTable table = new HTable(config, "SensorTagTablekumar");
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("SensorTagTablekumar");
         admin.deleteTable("SensorTagTablekumar");
